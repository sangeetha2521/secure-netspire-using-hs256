...
sgMail.setApiKey('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')
...
exports.create = (req, res) => {
    ...
    order.save((error, data) => {
        ...
        // order.amount
        const emailData = {
            to: 'sangins8101@gmail.com', // admin
        ...
        res.json(data);
            ...
            //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